...
public class ShopService {
    ...
    public String getItems() {
    	...
    	for(Element e : doc.getRootElement().getChildren()) {
    		...
    		j.put("id", e.getChild("itemID", ServerRequests.namespace).getValue());
    		j.put("name", e.getChild("itemName", ServerRequests.namespace).getValue());
    		j.put("description", e.getChild("itemDescription", ServerRequests.namespace).getValue());
    		j.put("stock", e.getChild("itemStock", ServerRequests.namespace).getValue());
    		j.put("price", e.getChild("itemPrice", ServerRequests.namespace).getValue());
    		array.put(j);
    	}
